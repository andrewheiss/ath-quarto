...
I try to keep this updated fairly regularly. As of September 30, 2024 this is what I'm using: 
...
- I do my academic writing in several different programs: for stats-heavy stuff, I use [RStudio](https://posit.co/download/rstudio-desktop/) or [Positron](https://github.com/posit-dev/positron), and for prose-heavy stuff, I use [Obsidian](https://obsidian.md/) or [Typora](https://typora.io/). I used to use [Ulysses](http://ulyssesapp.com/) (and still think it's a fantastic app!), but I found that I wasn't using it as much in the past few years as I've switched to Quarto for my writing.
