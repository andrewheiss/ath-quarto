...
Sticking Middle Earth in the US makes sense because I live in the US, so these relative distances make sense to me. (I'm in Georgia, which is the middle of Mordor in the maps above).
...
#| fig-cap: "OpenStreeMap's site for exporting bounding box coordinates"
#| fig-alt: "OpenStreeMap's site for exporting bounding box coordinates"
...
```{r numenor-map, warning=FALSE, fig.width=6.5, fig.height=6}
