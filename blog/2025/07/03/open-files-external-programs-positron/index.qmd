...
One spot of friction in this workflow is getting a `.qmd` file in Positron open in Typora. I typically need to right click on the `.qmd` file in the File Explorer Pane, select "Reveal in Finder" to open it in macOS Finder, then right click on the `.qmd` file in Finder, select "Open With" and finally choose Typora:
