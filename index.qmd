...
description-meta: "Andrew Heiss is an assistant professor at Georgetown University in Qatar, researching international NGOs and teaching data science."
main-photo: /files/profiles/andrew-heiss-2026.jpg
main-photo-square: /files/profiles/andrew-heiss-2026-square.jpg
...
I'm an assistant professor at Edmund A. Walsh School of Foreign Service at [Georgetown University in Qatar](https://guq.qatar.georgetown.edu/). Prior to coming to Qatar, I was assistant professor in the [Department of Public Management and Policy](https://aysps.gsu.edu/public-management-policy/) at the [Andrew Young School of Policy Studies](https://aysps.gsu.edu/) at [Georgia State University](https://www.gsu.edu/). I received a PhD in public policy and political science from Duke University's [Sanford School of Public Policy](http://sanford.duke.edu/) in 2017.
...
I teach courses on [quantitative research methods and data science](https://quantf26.classes.andrewheiss.com/), [program evaluation and causal inference](https://evalf22.classes.andrewheiss.com/), [data visualization](https://datavizs22.classes.andrewheiss.com/), [economics](https://econs22.classes.andrewheiss.com/), and [science communication](https://storiesf17.classes.andrewheiss.com/). I'm also a [certified RStudio instructor](https://education.rstudio.com/trainers/people/heiss+andrew/) and a [Posit Academy mentor](https://posit.co/products/enterprise/academy/) and absolutely love teaching how to use [R](https://www.r-project.org/) and [the tidyverse](https://www.tidyverse.org/).
