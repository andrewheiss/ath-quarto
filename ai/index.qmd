...
::: {.fs-3}
Everything on this website, my research, and my courses is written by me, personally—not by an AI. 
...
Check out ["The '/ai' manifesto"](https://www.bydamo.la/p/ai-manifesto) to learn why I made this page!
:::
...
Learning is hard. Learning requires failure and repetition and more failure and more repetition. As the [writer Ted Chiang](https://en.wikipedia.org/wiki/Ted_Chiang) says, "Using ChatGPT to complete assignments is like bringing a forklift into the weight room; you will never improve your cognitive fitness that way."[@Chiang:2024]
