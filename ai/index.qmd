...
Here's my current thinking about using LLMs, as of February 17, 2026:
...
To avoid falling into over-reliance on LLM-assisted code help, I add as much friction into my workflow as possible. I only use GitHub Copilot and Claude in the browser, not through the chat sidebar in Positron or Visual Studio Code. When I use Claude Code, I don't use it in real projects—I use it in separate projects with simulated data and have it create Quarto files explaining what it does. I treat the code LLMs generate like random answers from StackOverflow or blog posts and generally rewrite it completely. I disable the inline LLM-based auto complete in text editors. For routine tasks like generating {roxygen2} documentation scaffolding for functions, I use [the {chores} package](https://posit.co/blog/introducing-chores/), which requires a bunch of pointing and clicking to use.

### Research

I don't use LLMs for research. I hate that they're incorporated into search engine results. 

And I super hate that their output is infecting published academic work—and even made it on record [in *Rolling Stone*](https://www.rollingstone.com/culture/culture-features/ai-chatbot-journal-research-fake-citations-1235485484/) talking about this ([unpaywalled](https://archive.is/0Iuo6){.small}).
